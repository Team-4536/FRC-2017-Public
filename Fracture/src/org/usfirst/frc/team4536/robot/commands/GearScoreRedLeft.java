...
public class GearScoreRedLeft extends CommandGroup {
    ...
    public GearScoreRedLeft() {
    	...
    	addSequential(new DriveMotionProfile(Constants.GEAR_SCORE_RED_LEFT_DISTANCE, Constants.GEAR_SCORE_RED_LEFT_GOAL_ANGLE, Constants.GEAR_SCORE_RED_LEFT_START_ANGLE, true));
